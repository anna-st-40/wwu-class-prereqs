document.addEventListener('DOMContentLoaded', () => {
    ...
    const prefixColors = {
        ...
        "SPAN": "#F08080",  // Light Coral
        "SPCH": "#FA8072",  // Salmon
        "SPED": "#c2c5c5",  // Light Grey
        "SPPA": "#FA8072",  // Salmon
        "TECH": "#c2c5c5",  // Light Grey
        "WRIT": "#c2c5c5"   // Light Grey
    };
    ...
    d3.json('data.json').then(data => {
        ...
        console.log('Nodes:', nodes);  // Debug: Check nodes
        ...
        console.log('Links:', links);  // Debug: Check links

        // Set up the D3 force simulation
        const simulation = d3.forceSimulation(nodes)
            .force('link', d3.forceLink(links).id(d => d.id).distance(150))  // Increase distance between connected nodes
            .force('charge', d3.forceManyBody().strength(-500))  // Increase strength to push nodes apart
